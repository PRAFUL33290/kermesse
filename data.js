...
const FREE_CATEGORIES = [
  ...
  { name: "Chant", icon: "mic", scenes: [ { who: ["Jasmine","Léa S."], scene: "Lush Life" }, { who: ["Cheid"], scene: "Chant" }, { who: ["Maïmouna"], scene: "Chant" }, { who: ["Céline"], scene: "Chant" }, { who: ["Lina M."], scene: "Chant" }, { who: ["Keren"], scene: "Chant" }, { who: ["Ibrahim"], scene: "Ciel" }, { who: ["Charlotte"], scene: "Chant" }, { who: ["Jumana"], scene: "À confirmer" } ] },
