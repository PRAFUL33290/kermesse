...
const FREE_CATEGORIES = [
  ...
  { name: "Chant", icon: "mic", scenes: [ { who: ["Jasmine","Léa S."], scene: "Lush Life" }, { who: ["Cheid"], scene: "Chant" }, { who: ["Maïmouna"], scene: "Chant" }, { who: ["Céline"], scene: "Chant" }, { who: ["Lina M."], scene: "Chant" }, { who: ["Keren"], scene: "Chant" }, { who: ["Ibrahim"], scene: "Ciel" }, { who: ["Charlotte"], scene: "Chant" }, { who: ["Jumana"], scene: "À confirmer" }, { who: ["Youga"], scene: "Rnboi - Mon bébé" } ] },
  { name: "Jonglage ballon de foot", icon: "football", scenes: [ { who: ["Courage","Eliam"], scene: "Jonglage" } ] },
  { name: "Danse", icon: "dance", scenes: [ { who: ["Kaylan","Elvin","Arthur","Alioun"], scene: "Astronomia", duration: "~3 min" }, { who: ["Alya","Elenna"], scene: "Spa", duration: "~2 à 3 min" }, { who: ["Alya","Elenna","Elaïa","Kelyana"], scene: "Danse / gym — Lush Life", duration: "~3 min max" }, { who: ["Jasmine","Léa S."], scene: "Gozalo", duration: "~3 min" }, { who: ["Lina S.","Maïssa"], scene: "Danse Brésil — musique à confirmer", duration: "~3 min" }, { who: ["Clara"], scene: "Thriller", duration: "~1 min" }, { who: ["Grace"], scene: "Solo danse — musique à voir", duration: "~1 à 2 min" }, { who: ["Clara","Lydia","Divine","Ryma"], scene: "Danse — à confirmer", duration: "à confirmer" }, { who: ["Lana"], scene: "Séga", duration: "à confirmer" }, { who: ["Giulia","Heloise"], scene: "Gabriela", duration: "à confirmer" }, { who: ["Stella","Giulia"], scene: "21 Reasons", duration: "à confirmer" }, { who: ["Heloise","Juliette","Loicia"], scene: "Danse", duration: "à confirmer" }, { who: ["Mamy Kadiatou"], scene: "Solo afro", duration: "à confirmer" } ] },
