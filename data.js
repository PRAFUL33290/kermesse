...
const SCHOOL_PROJECTS = [
  ...
  },
  {
    ...
    languages: [
      { flag: "France", country: "France", lang: "Français", kids: ["Lilly","Lydia","Myla","Kelyana","Elaia","Juliette","Ilona","Jasmine","Guillia","Elenna","Mia","Alya","Divine","Lina M.","Alicia","Eileen","Léana","Céline","Cheid","Asma","Lina E."] },
...
const FREE_CATEGORIES = [
  ...
  { name: "Danse", icon: "dance", scenes: [ { who: ["Kaylan","Elvin","Arthur","Alioun"], scene: "Astronomia", duration: "~3 min" }, { who: ["Alya","Elenna"], scene: "Spa", duration: "~2 à 3 min" }, { who: ["Alya","Elenna","Elaïa","Kelyana"], scene: "Danse / gym — Lush Life", duration: "~3 min max" }, { who: ["Jasmine","Léa S."], scene: "Gozalo", duration: "~3 min" }, { who: ["Lina S.","Maïssa"], scene: "Danse Brésil — musique à confirmer", duration: "~3 min" }, { who: ["Clara"], scene: "Thriller", duration: "~1 min" }, { who: ["Grace"], scene: "Solo danse — musique à voir", duration: "~1 à 2 min" }, { who: ["Clara","Lydia","Divine","Ryma"], scene: "Danse — à confirmer", duration: "à confirmer" }, { who: ["Giulia","Heloise"], scene: "Gabriela", duration: "à confirmer" }, { who: ["Stella","Giulia"], scene: "21 Reasons", duration: "à confirmer" }, { who: ["Heloise","Juliette","Loicia"], scene: "Danse", duration: "à confirmer" }, { who: ["Mamy Kadiatou"], scene: "Solo afro", duration: "à confirmer" } ] },
  { name: "Gymnastique", icon: "gym", scenes: [ { who: ["Giulia","Stella","Héloïse","Eileen","Lya","Lina S.","Maïssa","Alya","Elenna","Elaïa","Kelyana","Yara","Keren","Tania","Husna","Alicia","Lydia","Naima Nour","Mélina B.","Mélyna A.","Léana","Céline"], scene: "Rondades / flip / salto arrière (toutes ensemble)" }, { who: ["Giulia","Stella","Héloïse"], scene: "Gym groupe" }, { who: ["Lina S.","Maïssa"], scene: "Gym duo" }, { who: ["Camille","Héloïse"], scene: "Gym duo" }, { who: ["Mélina B."], scene: "Solo gymnastique" } ] },
...
const NAME_ALIASES = { "mayssae": "Maïssa", "maissae": "Maïssa", "guillia": "Giulia", "elenna": "Elenna", "elena": "Elenna", "elaia": "Elaïa", "shine": "Shyne", "lina m": "Lina M.", "maimouna": "Maimouna", "heloise": "Héloïse", "leana": "Léana", "lily": "Lilly", "loicia": "Loïcia", "maissa": "Maïssa", "chahd": "Cheid", "naima nour": "Naïma Nour", "housna": "Husna", "melyna b": "Mélina B.", "melyna b.": "Mélina B.", "melina b": "Mélina B.", "melina b.": "Mélina B.", "mélina b": "Mélina B.", "mélina b.": "Mélina B.", "melyna adenet": "Mélyna A.", "melina adenet": "Mélyna A.", "mélina adenet": "Mélyna A.", "melyna a": "Mélyna A.", "melyna a.": "Mélyna A.", "mélyna a": "Mélyna A.", "mélyna a.": "Mélyna A.", "melina": "Melyna", "mélina": "Melyna" };
