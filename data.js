...
const FREE_CATEGORIES = [
  ...
  { name: "Danse", icon: "dance", scenes: [ { who: ["Kaylan","Elvin","Arthur","Alioun"], scene: "Astronomia", duration: "~3 min" }, { who: ["Jasmine","Léa S."], scene: "Gozalo", duration: "~3 min" }, { who: ["Lydia","Yara"], scene: "Pilé", duration: "~3 min" }, { who: ["Mamy Kadiatou","Lina S.","Maïssa"], scene: "Samba du Brésil", duration: "~3 min" }, { who: ["Alya CM2","Elenna","Kelyana"], scene: "Spa", duration: "~2 à 3 min" }, { who: ["Alya CM2","Elenna","Elaïa","Kelyana"], scene: "Danse / gym — Lush Life", duration: "~3 min max" }, { who: ["Giulia","Heloise","Stella"], scene: "Gabriela", duration: "à confirmer" }, { who: ["Stella","Giulia","Heloise"], scene: "21 Reasons", duration: "à confirmer" }, { who: ["Camille","Heloise","Juliette","Loicia"], scene: "21 Reasons", duration: "à confirmer" }, { who: ["Camille","Héloïse"], scene: "No batidao (version instrumentale)", duration: "~3 min" } ] },
  { name: "Gymnastique", icon: "gym", scenes: [ { who: ["Alya CM2","Elaïa"], scene: "GRS — Taki Taki", duration: "~3 min" }, { who: ["Mélina B."], scene: "Solo gymnastique" }, { who: ["Lina S.","Maïssa"], scene: "Gym duo" }, { who: ["Giulia","Stella","Héloïse","Eileen","Lya","Lina S.","Maïssa","Alya CP","Alya CM2","Elenna","Elaïa","Kelyana","Yara","Keren","Tania","Alicia","Lydia","Naima Nour","Mélina B.","Mélyna A.","Léana","Céline","Haby Hawa","Thalia F."], scene: "Rondades / flip / salto arrière (toutes ensemble)", duration: "~10 min" } ] },
  { name: "Roller", icon: "roller", scenes: [ { who: ["Thalia F.","Naïma Nour","Mélyna A.","Haby Hawa","Dina"], scene: "Roller — Thalia entre seule puis sort ; Naïma Nour, Mélyna A. et Haby Hawa ensemble puis sortent ; Dina finit", duration: "~5 à 7 min" } ] }
];

const NAME_ALIASES = { "mayssae": "Maïssa", "maissae": "Maïssa", "guillia": "Giulia", "elenna": "Elenna", "elena": "Elenna", "elaia": "Elaïa", "shine": "Shyne", "lina m": "Lina M.", "lina": "Lina S.", "maimouna": "Maimouna", "heloise": "Héloïse", "leana": "Léana", "lily": "Lilly", "loicia": "Loïcia", "maissa": "Maïssa", "chahd": "Cheid", "naima nour": "Naïma Nour", "haby": "Haby Hawa", "hawa": "Haby Hawa", "housna": "Husna", "husna": "Husna", "melyna b": "Mélina B.", "melyna b.": "Mélina B.", "melina b": "Mélina B.", "melina b.": "Mélina B.", "mélina b": "Mélina B.", "mélina b.": "Mélina B.", "melyna adenet": "Mélyna A.", "melina adenet": "Mélyna A.", "mélina adenet": "Mélyna A.", "melyna a": "Mélyna A.", "melyna a.": "Mélyna A.", "mélyna a": "Mélyna A.", "mélyna a.": "Mélyna A.", "melina": "Melyna", "mélina": "Melyna" };
...
function sceneDurationMin(scene) {
  ...
  if (scene.duration && scene.duration.includes("10 min")) return 10;
